...
bool ShadowMapTechnique::Init()
{
    ...
    if (!AddShader(GL_VERTEX_SHADER, "/home/lparkin/Projects/S3/OpenGlDirsProject/Tutorial23/shadow_map.vs")) {
        return false;
    }

    if (!AddShader(GL_FRAGMENT_SHADER, "/home/lparkin/Projects/S3/OpenGlDirsProject/Tutorial23/shadow_map.fs")) {
        return false;
    }
