...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pLightingEffect->Init("/home/lparkin/Projects/S3/OpenGlDirsProject/Tutorial24/lighting.vs",
                                     "/home/lparkin/Projects/S3/OpenGlDirsProject/Tutorial24/lighting.fs")) {
        ...
        if (!m_pShadowMapEffect->Init("/home/lparkin/Projects/S3/OpenGlDirsProject/Tutorial24/shadow_map.vs",
                                      "/home/lparkin/Projects/S3/OpenGlDirsProject/Tutorial24/shadow_map.fs")) {
    ...
    if (!m_pQuad->LoadMesh(
               "/home/lparkin/Projects/S3/OpenGlDirsProject/LearnOpenGL-nonQt/Project/Content/quad.obj")) {
            return false;
        }

    m_pGroundTex = new Texture(GL_TEXTURE_2D,
               "/home/lparkin/Projects/S3/OpenGlDirsProject/LearnOpenGL-nonQt/Project/Content/test.png");
