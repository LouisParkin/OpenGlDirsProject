...
public:
  ...
  bool Init()
  {
    ...
    if (!m_pLightingTechnique->Init("/home/lparkin/Projects/S3/OpenGlDirsProject/LearnOpenGL-nonQt/Common/Shaders/basic_lighting.vs",
    ...
    if (!m_pTankMesh->LoadMesh(
          "/home/lparkin/Projects/S3/OpenGlDirsProject/LearnOpenGL-nonQt/Project/Content/phoenix_ugv.md2")) {
      return false;
    }

    m_pSkyBox = new SkyBox(m_pGameCamera, m_persProjInfo);

    if (!m_pSkyBox->Init("/home/lparkin/Projects/S3/OpenGlDirsProject/LearnOpenGL-nonQt/Project/Content/",
                         "sp3right.jpg",
                         "sp3left.jpg",
                         "sp3top.jpg",
                         "sp3bot.jpg",
