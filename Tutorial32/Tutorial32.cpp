...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pEffect->Init("/home/lparkin/Projects/S3/OpenGlDirsProject/LearnOpenGL-nonQt/Common/Shaders/basic_lighting.vs",
                             "/home/lparkin/Projects/S3/OpenGlDirsProject/LearnOpenGL-nonQt/Common/Shaders/basic_lighting.fs")) {
        ...
        if (!m_pMesh1->LoadMesh("/home/lparkin/Projects/S3/OpenGlDirsProject/LearnOpenGL-nonQt/Project/Content/phoenix_ugv.md2")) {
            return false;            
        }
        
        m_pMesh2 = new BasicMesh();

        if (!m_pMesh2->LoadMesh("/home/lparkin/Projects/S3/OpenGlDirsProject/LearnOpenGL-nonQt/Project/Content/jeep.obj")) {
            return false;            
        }

        m_pMesh3 = new BasicMesh();

        if (!m_pMesh3->LoadMesh("/home/lparkin/Projects/S3/OpenGlDirsProject/LearnOpenGL-nonQt/Project/Content/hheli.obj")) {
            return false;            
        }
