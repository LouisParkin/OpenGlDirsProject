...
public:
  ...
  bool Init()
  {
    ...
    if (!m_DSGeomPassTech.Init("/home/lparkin/Projects/S3/OpenGlDirsProject/Tutorial37/shaders/geometry_pass.vs",
                               "/home/lparkin/Projects/S3/OpenGlDirsProject/Tutorial37/shaders/geometry_pass.fs")) {
    ...
    if (!m_DSPointLightPassTech.Init("/home/lparkin/Projects/S3/OpenGlDirsProject/Tutorial37/shaders/light_pass.vs",
                                     "/home/lparkin/Projects/S3/OpenGlDirsProject/Tutorial37/shaders/point_light_pass.fs")) {
    ...
    if (!m_DSDirLightPassTech.Init("/home/lparkin/Projects/S3/OpenGlDirsProject/Tutorial37/shaders/light_pass.vs",
                                   "/home/lparkin/Projects/S3/OpenGlDirsProject/Tutorial37/shaders/dir_light_pass.fs")) {
    ...
    m_DSDirLightPassTech.SetWorldViewProjection(WorldViewProjection);

    if (!m_nullTech.Init("/home/lparkin/Projects/S3/OpenGlDirsProject/Tutorial37/shaders/null_technique.vs",
                         "/home/lparkin/Projects/S3/OpenGlDirsProject/Tutorial37/shaders/null_technique.fs")) {
      return false;
    }

    if (!m_quad.LoadMesh("/home/lparkin/Projects/S3/OpenGlDirsProject/LearnOpenGL-nonQt/Project/Content/quad.obj")) {
      return false;
    }

    if (!m_box.LoadMesh("/home/lparkin/Projects/S3/OpenGlDirsProject/LearnOpenGL-nonQt/Project/Content/box.obj")) {
      return false;
    }

    if (!m_bsphere.LoadMesh("/home/lparkin/Projects/S3/OpenGlDirsProject/LearnOpenGL-nonQt/Project/Content/sphere.obj")) {
      return false;
    }
  ...
  void DSGeometryPass()
  {
    ...
    for (unsigned int i = 0 ; i < ARRAY_SIZE_IN_ELEMENTS(m_boxPositions) ; i++) {
      ...
      m_DSGeomPassTech.SetWorldViewProjection(p.GetWorldViewProjectionTrans());
  ...
  void DSStencilPass(unsigned int PointLightIndex)
  {
    ...
    m_nullTech.SetWorldViewProjection(p.GetWorldViewProjectionTrans());
    m_bsphere.Render();
  }
  ...
  void DSPointLightPass(unsigned int PointLightIndex)
  {
    ...
    p.SetCamera(m_pGameCamera->GetPos(), m_pGameCamera->GetTarget(), m_pGameCamera->GetUp());
    p.SetPerspectiveProj(m_persProjInfo);
    m_DSPointLightPassTech.SetWorldViewProjection(p.GetWorldViewProjectionTrans());
